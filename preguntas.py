...
def pregunta_09():
    ...
    """
    tbl0['year'] = pd.to_datetime(tbl0['_c3'], errors='coerce').dt.year.fillna(0).astype(int)
    return tbl0
...
def pregunta_10():
    ...
    tbl0_grouped = tbl0_grouped.set_index('_c1')
    return tbl0_grouped
...
def pregunta_11():
    ...
    39   39    a,d,f
    """
    tbl1_grouped = tbl1.groupby('_c0')['_c4'].apply(lambda x: ','.join(map(str, sorted(x)))).reset_index()
    return tbl1_grouped
...
def pregunta_12():
    ...
    tbl2_grouped = tbl2.groupby('_c0')['_c5'].apply(lambda x: ','.join(map(str, sorted(x)))).reset_index()
    return tbl2_grouped
